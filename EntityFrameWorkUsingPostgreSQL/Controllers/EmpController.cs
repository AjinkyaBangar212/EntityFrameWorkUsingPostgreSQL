...
using EntityFrameWorkUsingPostgreSQL.DataContext;
using EntityFrameWorkUsingPostgreSQL.Models;

namespace EntityFrameWorkUsingPostgreSQL.Controllers
{
    public class EmpController : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext(); //  public EmpController (){db=new ApplicationDbContext();}
